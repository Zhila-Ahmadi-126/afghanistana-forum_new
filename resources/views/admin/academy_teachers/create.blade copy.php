...
placeholder="Education background">{{ old('education') }}</textarea>
...
placeholder="Work experience">{{ old('experience') }}</textarea>
...
placeholder="Teacher biography">{{ old('biography') }}</textarea>
