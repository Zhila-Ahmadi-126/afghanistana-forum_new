...
src="{{ $user->avatar 
    ? asset($user->avatar)
    : asset('dashboard/images/avatar/default.JPG') }}"
...
<span class="ZAedAge-masterText">Select All</span>
...
<img src="{{ asset('dashboard/images/avatar/male/'.$i.'.JPG') }}"
     class="choose-avatar"
     data-avatar="male/{{ $i }}.JPG">

<img src="{{ asset('dashboard/images/avatar/female/'.$i.'.JPG') }}"
     class="choose-avatar"
