...
<title>{{ __('users_create.title') }}</title>
...
<h4>{{ __('users_create.choose_avatar') }}</h4>
...
<label>{{ __('users_create.first_name') }}</label>
...
<label>{{ __('users_create.last_name') }}</label>
...
<label>{{ __('users_create.username') }}</label>
...
<label>{{ __('users_create.email') }}</label>
...
<label>{{ __('users_create.phone') }}</label>
...
<label>{{ __('users_create.gender') }}</label>

<select
    name="gender"
    class="form-control">

    <option value="Male">{{ __('users_create.male') }}</option>
    <option value="Female">{{ __('users_create.female') }}</option>
...
<label>{{ __('users_create.role') }}</label>

<select
    name="role"
    class="form-control">

    <option value="super_admin">{{ __('users_create.super_admin') }}</option>
    <option value="admin">{{ __('users_create.admin') }}</option>
    <option value="member">{{ __('users_create.member') }}</option>
    <option value="user">{{ __('users_create.user') }}</option>
...
<label>{{ __('users_create.status') }}</label>

<select
    name="status"
    class="form-control">

    <option value="active">{{ __('users_create.active') }}</option>
    <option value="inactive">{{ __('users_create.inactive') }}</option>
    <option value="pending">{{ __('users_create.pending') }}</option>
...
<label>{{ __('users_create.password') }}</label>
...
<label>{{ __('users_create.confirm_password') }}</label>
    ...
    <div class="ZAedAge-header">
        ...
        <div class="ZAedAge-titleBox">
            ...
            <h2 class="ZAedAge-title">
                {{ __('users_create.permissions_title') }}
            </h2>

            <p class="ZAedAge-subTitle">
                {{ __('users_create.permissions_description') }}
            </p>
        ...
        <div class="ZAedAge-group">
            ...
            <div class="ZAedAge-groupHeader">
                ...
                <label class="ZAedAge-groupLabel">
                    ...
                    <span>{{ __('users_create.select_group') }}</span>
            ...
            <div class="ZAedAge-grid">
                ...
                <label class="ZAedAge-card">
                    ...
                    <div class="ZAedAge-cardBox">
                        ...
                        <div class="ZAedAge-cardTitle">
                            {{ __('users_create.view') }}
                        </div>
    ...
    <div class="modal-dialog modal-xl modal-dialog-centered">
        ...
        <div class="modal-content glass-card">
            ...
            <div class="modal-header">
                ...
                <h5>{{ __('users_create.avatar_modal_title') }}</h5>
