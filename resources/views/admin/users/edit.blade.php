...
<title>{{ __('users_edit.title') }}</title>
...
<div class="col-md-3 text-center">
    ...
    <h4>{{ __('users_edit.choose_photo') }}</h4>
...
<label>{{ __('users_edit.first_name') }}</label>
...
<label>{{ __('users_edit.last_name') }}</label>
...
<label>{{ __('users_edit.username') }}</label>
...
<label>{{ __('users_edit.email') }}</label>
...
<label>{{ __('users_edit.phone') }}</label>
...
<label>{{ __('users_edit.gender') }}</label>
...
<label>{{ __('users_edit.status') }}</label>

<select name="status" class="form-control">

<option value="active" {{ $user->status == 'active' ? 'selected' : '' }}>
    {{ __('users_edit.active') }}
</option>

<option value="inactive" {{ $user->status == 'inactive' ? 'selected' : '' }}>
    {{ __('users_edit.inactive') }}
</option>

<option value="pending" {{ $user->status == 'pending' ? 'selected' : '' }}>
    {{ __('users_edit.pending') }}
</option>
...
<div class="ZAedAge-container">
    ...
    <div class="ZAedAge-titleBox">
        ...
        <h2 class="ZAedAge-title">
            {{ __('users_edit.permissions_title') }}
        </h2>

        <p class="ZAedAge-subTitle">
            {{ __('users_edit.permissions_subtitle') }}
        </p>
...
<div class="ZAedAge-group">
    ...
    <div class="ZAedAge-groupHeader">
        ...
        <label class="ZAedAge-groupLabel">
            ...
            <input type="checkbox"
                   class="ZAedAge-groupCheck">

            <span class="ZAedAge-groupCheckbox"></span>

            <span>{{ __('users_edit.select_group') }}</span>
    ...
    <div class="ZAedAge-grid">
        ...
        <label class="ZAedAge-card">
            ...
            <input type="checkbox"
                   ...
                   {{ ($userPermission && $userPermission->can_view) ? 'checked' : '' }}>
...
<div class="text-right mt-4">
    ...
    <button type="submit"
        ...
        {{ __('users_edit.update_administrator') }}
...
<h5>{{ __('users_edit.avatar_modal_title') }}</h5>
...
<div class="avatar-grid">
    ...
    @for($i = 1; $i <= 8; $i++)
        ...
        <img
            src="{{ asset('storage/avatar/male/'.$i.'.JPG') }}"
            class="choose-avatar"
            data-avatar="avatar/male/{{ $i }}.JPG">

        <img
            src="{{ asset('storage/avatar/female/'.$i.'.JPG') }}"
            class="choose-avatar"
            data-avatar="avatar/female/{{ $i }}.JPG">
