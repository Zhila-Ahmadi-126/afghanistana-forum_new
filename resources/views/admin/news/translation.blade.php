...
<head>
    ...
    <title>{{ __('news_translation.news_translation') }}</title>
...
<div class="container py-5">
    ...
    <div class="d-flex justify-content-between align-items-center mb-4">
        ...
        <h2 class="font-weight-bold">
            ...
            {{ __('news_translation.news_translation') }}
            ...
            <div class="row">
                ...
                <div class="col-md-4 mb-3">
                    ...
                    <label>
                        ...
                        {{ __('news_translation.select_language') }}
        ...
        <form action="{{ route('admin.news.translation.save',$news->id) }}"
            ...
            <div class="row">
                ...
                <div class="col-md-12 mb-3">
                    ...
                    <label>
                        ...
                        {{ __('news_translation.short_description') }}
                ...
                <div class="col-md-6 mb-3">
                    ...
                    <label>
                        ...
                        {{ __('news_translation.meta_title') }}
                ...
                <div class="col-md-6 mb-3">
                    ...
                    <label>
                        ...
                        {{ __('news_translation.meta_description') }}
            ...
            <div class="text-right mt-4">
                ...
                <button type="submit"
                    ...
                    {{ __('news_translation.save_translation') }}
...
document.addEventListener("DOMContentLoaded", function(){
    ...
    if(form && btn){
        ...
        form.addEventListener("submit",function(){
            ...
            btn.innerHTML =
            '<span class="spinner-border spinner-border-sm me-2"></span>{{ __("news_translation.saving") }}';
...
function deleteTranslation(){
    ...
    if(confirm('{{ __("news_translation.delete_confirm") }}')){
