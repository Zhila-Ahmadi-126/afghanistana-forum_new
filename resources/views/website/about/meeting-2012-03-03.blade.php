    ...
    <div class="container meeting-wrapper">
        ...
        <div class="meeting-header">
            ...
            <h1 class="meeting-title">
                ...
                <span>Supreme Association of Afghan Jurists in Europe</span>
            </h1>
            ...
            <p class="meeting-subtitle">
                Messages, statements and documents presented during
                the scientific meeting of the Supreme Association
                of Afghan Jurists in Europe.
            </p>
        ...
        <div class="meeting-intro">
            ...
            <p>
                During this scientific meeting, several members and
                organizations presented messages, statements and
                congratulatory remarks. The related documents are
                available below for reading and reference.
            </p>
        ...
        <div class="meeting-documents">
            ...
            <article class="meeting-document-card" >
                ...
                <h3 class="meeting-document-title" style=" color: darkblue;">
                    Message from the Afghanistan Civil Society and Human Rights Organization
                </h3>

                <div class="meeting-document-footer">

                    <a href="{{ asset('assets/img/about/files/payam-jameemadani.pdf') }}"
                       target="_blank"
            ...
            <article class="meeting-document-card">
                ...
                <h3 class="meeting-document-title" style=" color: darkblue;">
                    Congratulatory Message from Professor Mahbooba Hoqooqmal, Professor of the Faculty of Law and Political Science and Member of the Independent
                     Commission for the Supervision of the Implementation of the Constitution
                </h3>

                <div class="meeting-document-footer">

                    <a href="{{ asset('assets/img/about/files/Payame Mahbuba Hoqooqmal.pdf') }}"
                       target="_blank"
                       rel="noopener noreferrer"
                       class="meeting-read-more">
            ...
            <article class="meeting-document-card">
                ...
                <h3 class="meeting-document-title" style=" color: darkblue;">
                    ...
                    Board of the Center for Work and Society
                </h3>

                <div class="meeting-document-footer">

                    <a href="{{ asset('assets/img/about/files/payame-kar-jamea.pdf') }}"
                       target="_blank"
                       rel="noopener noreferrer"
                       class="meeting-read-more">
            ...
            <article class="meeting-document-card">
                ...
                <div class="meeting-document-footer">
                    ...
                    <a href="{{ asset('assets/img/about/files/holland-3march.pdf') }}"
                       target="_blank"
                       rel="noopener noreferrer"
                       class="meeting-read-more">
            ...
            <article class="meeting-document-card">
                ...
                <h3 class="meeting-document-title" style=" color: darkblue;">
                    Message from Saghar Younesi – Hamburg
                </h3>

                <div class="meeting-document-footer">

                    <a href="{{ asset('assets/img/about/files/saghar-yunosi.pdf') }}"
                       target="_blank"
                       rel="noopener noreferrer"
                       class="meeting-read-more">
            ...
            <article class="meeting-document-card">
                ...
                <h3 class="meeting-document-title" style=" color: darkblue;">
                    Message from the Islamic Union of Afghan Migrants – Hannover
                </h3>

                <div class="meeting-document-footer meeting-multiple-files">

                    <a href="{{ asset('assets/img/about/files/hanovar-1.pdf') }}"
                       target="_blank"
                       rel="noopener noreferrer"
                       class="meeting-read-more">
                    ...
                    <a href="{{ asset('assets/img/about/files/hanovar.pdf') }}"
                       target="_blank"
                       rel="noopener noreferrer"
                       class="meeting-read-more">
            ...
            <article class="meeting-document-card">
                ...
                <h3 class="meeting-document-title" style=" color: darkblue;">
                   Message from Associate Professor Abdul Qader "Adalatkhwah",
                    Professor of the Faculty of Law and Political Science, Kabul University
                </h3>

                <div class="meeting-document-footer">

                    <a href="{{ asset('assets/img/about/files/payame-Adalatkhwah.pdf') }}"
                       target="_blank"
                       rel="noopener noreferrer"
                       class="meeting-read-more">
            ...
            <article class="meeting-document-card">
                ...
                <h3 class="meeting-document-title" style=" color: darkblue;">
                    Message from Dr. Mohammad Taher Hashemi, 
                    Professor of the Faculty of Law and Political Science, Kabul University
                </h3>

                <div class="meeting-document-footer">

                    <a href="{{ asset('assets/img/about/files/payame-t-hashemi.pdf') }}"
                       target="_blank"
                       rel="noopener noreferrer"
                       class="meeting-read-more">
            ...
            <article class="meeting-document-card">
                ...
                Ahmad Morid, on behalf of a number of
                ...
                <div class="meeting-document-footer">
                    ...
                    <a href="{{ asset('assets/img/about/files/morid-1.pdf') }}"
                       target="_blank"
                       rel="noopener noreferrer"
                       class="meeting-read-more">
            ...
            <article class="meeting-document-card">
                ...
                <h3 class="meeting-document-title" style=" color: darkblue;">
                    Message from Afghan lawyers residing in Denmark
                </h3>

                <div class="meeting-document-footer">

                    <a href="{{ asset('assets/img/about/files/payame-DK.pdf') }}"
                       target="_blank"
                       rel="noopener noreferrer"
                       class="meeting-read-more">
